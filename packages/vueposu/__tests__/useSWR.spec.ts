...
import useSWR, { mutate, trigger, useSWRGlobalConfig } from '../src/useSWR';
import cache from '../src/useSWR/cache';
import { triggerDomEvent, wait } from '@vueposu/shared/utils/helper';
