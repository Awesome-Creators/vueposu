...
import { isServer, isEqual } from "@vueposu/utils";
...
if (!isServer) {
  ...
  originalSessionRemoveItem =
    window.sessionStorage.removeItem.bind(sessionStorage);
